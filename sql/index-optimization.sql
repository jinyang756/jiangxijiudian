...
ON orders(table_id, status, placed_at DESC, id DESC);
...
ON service_requests(table_number, resolved, created_at DESC, id DESC);
...
COMMENT ON INDEX idx_dishes_name_trgm IS '支持菜品名称模糊搜索的全文索引';
